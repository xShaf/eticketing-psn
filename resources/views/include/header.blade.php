<head>
    ...
    <link href="{{ url('assets/css/fontawesome-free-6.5.1-web/css/all.min.css') }}" crossorigin="anonymous" rel="stylesheet">
    ...
    <div class="container">
        <div class="row align-items-center justify-items-center">
            <div class="col-md-4 col-12 text-center">
                <a href="/home"><img src="{{ url('assets/images/logopsn.png') }}" width="350" height="150" alt=""></a>
            </div>
